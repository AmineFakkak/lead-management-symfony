 ...
 */
final class Version20260216115347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE interaction CHANGE subject subject VARCHAR(200) DEFAULT NULL, CHANGE outcome outcome VARCHAR(30) DEFAULT NULL');
